...
interface PaymentConfirmationEmailData {
  user: User
  payment: Payment & { campaign?: CampaignRequest }
  invoiceUrl?: string
}
...
export class EmailService {
  ...
  async sendLinkRequestEmail(data: LinkRequestEmailData): Promise<void> {
  ...
  async sendCampaignLaunchedEmail(data: CampaignLaunchedEmailData): Promise<void> {
  ...
  private async sendEmail(options: {
    ...
    try {
      ...
      throw new ExternalServiceError('Email', 'Failed to send email', error)
    }
  }
  ...
  private getLinkRequestTemplate(data: LinkRequestEmailData): EmailTemplate {
